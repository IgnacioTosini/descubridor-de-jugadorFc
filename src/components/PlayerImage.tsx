...
export const PlayerImage = ({ playerImages, currentImageIndex, showPlayerOverlay, showCountryOverlay, showLeagueOverlay, showTeamOverlay }: PlayerImageProps) => (
    <div className="relative flex justify-center">
        <div className="relative w-[386px]">
            ...
            />
            <div
                className={`absolute w-full h-[55%] pointer-events-none z-10 top-[15%] left-0 ${showPlayerOverlay ? 'fade-in' : 'fade-out'} rounded-[20%] backdrop-blur-[15px] transition-opacity duration-1000 ease`}></div>
